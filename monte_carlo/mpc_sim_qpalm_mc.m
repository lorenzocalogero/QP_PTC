...
save_data = true;
save_name = 'mpc_sim_qpalm_mc_1.mat';
...
fprintf('MPC simulation (QPALM) (Monte Carlo) (%d / %d)...\n', n, N_mc);
for k=1:1:N_sim
	...
	prob.setup(H_mpc, c_mpc, [A_eq_mpc; A_ineq_mpc], ...
		[b_eq_mpc; -inf*ones(length(b_ineq_mpc),1)], [b_eq_mpc;
	b_ineq_mpc], options);
